    ...
    await transporter.sendMail({
        ...
        html: `
            <div style="font-family:sans-serif;max-width:480px;margin:auto;padding:32px;background:#140C30;color:#fff;border-radius:16px">
                ...
                <div style="display:inline-block;padding:16px 24px;background:rgba(22,160,133,0.15);color:#fff;border-radius:12px;text-decoration:none;font-weight:bold;font-size:28px;letter-spacing:6px;margin:16px 0">
                    ${otp}
                </div>
